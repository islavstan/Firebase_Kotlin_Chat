...
import com.islavstan.firebasekotlinchat.utils.Constants;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) {
            ...
            if (!FirebaseChatMainApp.Companion.isChatActivityOpen()) {
    ...
    private void sendNotification(String title,
        ...
        intent.putExtra(Constants.getARG_RECEIVER(), receiver);
        intent.putExtra(Constants.getARG_RECEIVER_UID(), receiverUid);
        intent.putExtra(Constants.getARG_FIREBASE_TOKEN(), firebaseToken);
